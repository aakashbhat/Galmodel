...
\begin{figure}
\includegraphics[width=\columnwidth]{plots/MODELI/RotCurve/sofue(2009)/Rotcur_ModelI_eil_bhatta_log_10000.pdf}
\includegraphics[width=\columnwidth]{plots/MODELI/RotCurve/sofue(2021)/Rotcur_ModelI_eil_bhatta_log_10000.pdf}
\includegraphics[width=\columnwidth]{plots/MODELI/RotCurve/Reid(2014)/Rotcur_ModelI_eil_bhatta_log_10000.pdf}
...
\begin{figure}
\includegraphics[width=\columnwidth]{plots/MODELI/VertiF/sofue(2009)/VertForce_ModelI_10000.pdf}
\includegraphics[width=\columnwidth]{plots/MODELI/VertiF/sofue(2021)/VertForce_ModelI_10000.pdf}
\includegraphics[width=\columnwidth]{plots/MODELI/VertiF/Reid(2014)/VertForce_ModelI_10000.pdf}
...
\begin{figure}
\includegraphics[width=\columnwidth]{plots/MODELIII/Rotcurve/sofue(2009)/Rotcur_ModelIII_log_10000.pdf}
\includegraphics[width=\columnwidth]{plots/MODELIII/Rotcurve/sofue(2021)/Rotcur_ModelIII_log_10000.pdf}
\includegraphics[width=\columnwidth]{plots/MODELIII/Rotcurve/reid(2014)/Rotcur_ModelIII_log_10000.pdf}
\caption{The Rotation curve of the Milky Way in the Log scale for the best fit models and the original model 1 of Andreas for RC1 (top), RC2 (middle), and RC3 (bottom).
}
\label{fig:Model3_rc}
\end{figure}
\begin{figure}
\includegraphics[width=\columnwidth]{plots/MODELIII/VertiF/sofue(2009)/VertForce_ModelIII_10000.pdf}
\includegraphics[width=\columnwidth]{plots/MODELIII/VertiF/sofue(2021)/VertForce_ModelIII_10000.pdf}
\includegraphics[width=\columnwidth]{plots/MODELIII/VertiF/reid(2014)/VertForce_ModelIII_10000.pdf}
\caption{The Vertical force at 1.1 kpc for the best fit models and the original model 1 of Andreas.
}
