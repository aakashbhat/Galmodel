...
columns={Parameter,mcmc_mxl_1,mcmc_mode_1,mcmc_mxl_2sigma_plus_1,mcmc_mxl_2sigma_minus_1,mcmc_mxl_2,mcmc_mode_2,mcmc_mxl_2sigma_plus_2,mcmc_mxl_2sigma_minus_2,mcmc_mxl_3,mcmc_mode_3,mcmc_mxl_2sigma_plus_3,mcmc_mxl_2sigma_minus_3},
column type=c,
string type,
every head row/.style={before row={\hline\hline&\multicolumn{4}{c}{RC1}&\multicolumn{4}{c}{RC2}&\multicolumn{4}{c}{RC3}\\},after row=\hline,},
...
columns/mcmc_mxl_1/.style={column name= MXL,column type=c,numeric type,fixed,precision=2},
columns/mcmc_mode_1/.style={column name= Mode,column type=c,numeric type,fixed,precision=2},
columns/mcmc_mxl_2sigma_plus_1/.style={column name=MXL $2\sigma+$,column type=c,numeric type,fixed,precision=2},
columns/mcmc_mxl_2sigma_minus_1/.style={column name=MXL $2\sigma-$,column type=c,numeric type,fixed,precision=2},
columns/mcmc_mxl_2/.style={column name= MXL,column type=c,numeric type,fixed,precision=2},
columns/mcmc_mode_2/.style={column name= Mode,column type=c,numeric type,fixed,precision=2},
columns/mcmc_mxl_2sigma_plus_2/.style={column name=MXL $2\sigma+$,column type=c,numeric type,fixed,precision=2},
columns/mcmc_mxl_2sigma_minus_2/.style={column name=MXL $2\sigma-$,column type=c,numeric type,fixed,precision=2},
columns/mcmc_mxl_3/.style={column name= MXL,column type=c,numeric type,fixed,precision=2},
columns/mcmc_mode_3/.style={column name= Mode,column type=c,numeric type,fixed,precision=2},
columns/mcmc_mxl_2sigma_plus_3/.style={column name=MXL $2\sigma+$,column type=c,numeric type,fixed,precision=2},
columns/mcmc_mxl_2sigma_minus_3/.style={column name=MXL $2\sigma-$,column type=c,numeric type,fixed,precision=2},
]{\tableaf}
}
\tablefoot{I}
\end{table*}
...
The curves and fits are shown in \ref{fig:Model3_rc} and \ref{fig:Model3_vertif}.
 ...
 \pgfplotstableread[col sep=comma]{Model_III/output_params/fit_all_10000_100_params.csv}\tableaf
\begin{table*}
\centering
\caption{Fitted parameters values for Model III.}
\label{tab:model1params} 
\renewcommand{\arraystretch}{1.1}
\resizebox{0.9\textwidth}{!}{
\pgfplotstabletypeset[
